...
@section('title', 'Property Amenity')
...
@endpush
 <form action="{{route('pamenities')}}" method="get" id="getSubmitform">
        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h4 class="fw-bold">Property amenities</h4>
                    <h6>Manage your property amenity</h6>
                </div>
            </div>
            <div class="page-btn">
                <a href="#" class="btn btn-primary clearform" data-bs-toggle="modal" data-bs-target="#add-amenity">
                    <i class="ti ti-circle-plus me-1"></i>Add Property Amenity
                </a>
            </div>
        </div>
        <!-- Category List -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="page-title">
                        <h4 id="modalTitle">Add Property Amenity</h4>
                    </div>
                ...
                <div id="errorMsg"></div>
                <form action="{{ route('pastore') }}" method="post" id="amenityForm">
...
$(function () {
 const $form           = $('#amenityForm');
  const listUrl         = "{{ route('pajaxamenitylist') }}";
 const editUrl         = "{{ route('peditAmenitylist') }}";
const updateUrl       = "{{ route('pupdateAmenitylist') }}";
        ...
        $.post(editUrl, { id })
         .done(resp => {
             if (resp.status) {
                 ...
                 clearForm();
                 $('#name').val(c.pamenity_text);                 // << proper key
                 $('#amenity_id').val(c.id);
