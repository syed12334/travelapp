<table class="table">
    ...
    <tbody>
        @forelse ($amenity as $amen)
            <tr>
                <td>
                    <label class="checkboxs">
                        <input type="checkbox" class="select-row" name="amenity_id[]" value="{{ $amen->id }}" onclick="return deleteMultiple({{ $amen->id; }})">
                        <span class="checkmarks"></span>
                ...
                <td class="action-table-data">
                    <div class="edit-delete-action">
                        @if ($amen->status == 1)
                            <a data-status="0" data-id="{{ $amen->id }}" data-msg="Are you sure you want to deactivate this amenity?"  class="me-2 p-2 mb-0 statusChange" href="javascript:void(0)">
                                <i class="ti ti-lock-cancel" title="Deactivate Property Amenity"></i>
                            </a>
                        @else
                            <a data-status="1" data-id="{{ $amen->id }}" data-msg="Are you sure you want to activate this amenity?"  class="me-2 p-2 mb-0 statusChange" href="javascript:void(0)" >
                                <i class="ti ti-check" title="Activate Property Amenity"></i>
                            </a>
                        @endif
        ...
        @empty
            <tr>
                <td colspan="6" class="text-center text-muted">No property amenity found.</td>
            </tr>
        @endforelse
    </tbody>
</table>
