...
@endpush
 <form action="{{route('amenities')}}" method="get" id="getSubmitform">
        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    <h4 class="fw-bold">Room Amenities</h4>
                    <h6>Manage your room amenity</h6>
                </div>
            </div>
            <div class="page-btn">
                <a href="#" class="btn btn-primary clearform" data-bs-toggle="modal" data-bs-target="#add-amenity">
                    <i class="ti ti-circle-plus me-1"></i>Add Amenity
                </a>
            </div>
        </div>
        <!-- Category List -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="page-title">
                        <h4 id="modalTitle">Add Amenity</h4>
                    </div>
                ...
                <div id="errorMsg"></div>
                <form action="{{ route('astore') }}" method="post" id="amenityForm">
...
$(function () {
 const $form           = $('#amenityForm');
  const listUrl         = "{{ route('ajaxamenitylist') }}";
 const editUrl         = "{{ route('editAmenitylist') }}";
const updateUrl       = "{{ route('updateAmenitylist') }}";
        ...
        $.post(editUrl, { id })
         .done(resp => {
             if (resp.status) {
                 ...
                 clearForm();
                 $('#name').val(c.amenity_text);                 // << proper key
                 $('#amenity_id').val(c.id);
