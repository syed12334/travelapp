...
<head>
	...
	<!-- Styles -->
	<link href="{{ asset('app/css/jquery.filer.css') }}" rel="stylesheet">
	<link href="{{ asset('app/css/jquery.filer-dragdropbox-theme.css') }}" rel="stylesheet">
...
<body>
	...
	<script src="{{ asset('app/js/jquery.filer.min.js') }}" type="text/javascript"></script>
	<script src="{{ asset('app/js/custom.js') }}" type="text/javascript"></script>
    </body>
</html>
