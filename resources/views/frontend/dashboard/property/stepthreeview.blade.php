...
@section('content')
       <main id="main">
            ...
            <ul id="progress_header">
             ...
             @include('frontend.dashboard.property.step3')
...
@push('script')
          <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.5/jquery.validate.min.js"></script>
            <script type="text/javascript" src="{{ asset('app/js/image-uploader.min.js'); }}"></script>
 ...
 $('.input-images-1').imageUploader({
    ...
    extensions:['.jpg','.jpeg','.png'],
     multiple: true,
        ...
        /* Append youtube link*/
        var i =1;
        function appendYLink() {
            i++;
            var data = "<div class='row' id='removeY"+i+"' style='margin-top:10px'>";
                data +='<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9"><div class="form-group"><input type="url" name="youtube_link[]" placeholder="Enter youtube link"></div></div>';
                data +='<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3" style="margin-top:0px"><button class="btn btn-primary" type="button" onclick="return appendYLink()"><i class="fa fa-plus"></i></button><button class="btn btn-danger" type="button" onclick="return removeYoutube('+i+')" style="margin-left:5px"><i class="fa fa-minus"></i></button></div>';
                data +="<div class='clearfix'></div>";
            data +="</div>";
            $('#appendYoutube').append(data);
        }
        /* Remove youtube link */
